...
public class ConfigurationAcknowledgedListener implements ByteBufferPacketListener {
    public static final ConfigurationAcknowledgedListener INSTANCE = new ConfigurationAcknowledgedListener();
