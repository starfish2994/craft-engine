...
public class CustomChatCompletionsListener implements ByteBufferPacketListener {
    public static final CustomChatCompletionsListener INSTANCE = new CustomChatCompletionsListener();
