...
public class PickItemFromBlockListener implements ByteBufferPacketListener {
    public static final PickItemFromBlockListener INSTANCE = new PickItemFromBlockListener();
