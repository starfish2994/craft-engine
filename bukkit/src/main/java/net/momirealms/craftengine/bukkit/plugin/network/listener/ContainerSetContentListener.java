...
public class ContainerSetContentListener implements ByteBufferPacketListener {
    public static final ContainerSetContentListener INSTANCE = new ContainerSetContentListener();
