...
public class PlaceGhostRecipeListener implements ByteBufferPacketListener {
    public static final PlaceGhostRecipeListener INSTANCE = new PlaceGhostRecipeListener();
