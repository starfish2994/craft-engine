...
public class ResourcePackResponseListener implements ByteBufferPacketListener {
    public static final ResourcePackResponseListener INSTANCE = new ResourcePackResponseListener();

    private ResourcePackResponseListener() {}
