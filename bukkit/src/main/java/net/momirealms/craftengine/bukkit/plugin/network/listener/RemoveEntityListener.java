...
public class RemoveEntityListener implements ByteBufferPacketListener {
    public static final RemoveEntityListener INSTANCE = new RemoveEntityListener();

    private RemoveEntityListener() {}
