...
public class ForgetLevelChunkListener implements ByteBufferPacketListener {
    public static final ForgetLevelChunkListener INSTANCE = new ForgetLevelChunkListener();
