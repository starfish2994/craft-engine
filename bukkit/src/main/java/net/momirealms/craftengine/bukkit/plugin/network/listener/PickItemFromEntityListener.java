...
public class PickItemFromEntityListener implements ByteBufferPacketListener {
    public static final PickItemFromEntityListener INSTANCE = new PickItemFromEntityListener();
