...
@ReflectionProxy(name = {"net.minecraft.network.chat.contents.PlainTextContents", "net.minecraft.network.chat.contents.LiteralContents"}, activeIf = "min_version=1.20.3")
