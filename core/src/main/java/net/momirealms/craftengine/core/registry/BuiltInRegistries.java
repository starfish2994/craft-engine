...
public final class BuiltInRegistries {
    ...
    public static final Registry<ItemCryptoAlgorithm<? extends Algorithm>> ITEM_CRYPTO_ALGORITHM = createConstantBoundRegistry(Registries.ITEM_CRYPTO_ALGORITHM, 16);
    // todo 修改
