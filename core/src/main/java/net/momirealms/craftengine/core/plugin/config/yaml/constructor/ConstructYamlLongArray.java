...
public class ConstructYamlLongArray extends ConstructYamlLong implements ConstructNode {

    @Override
    public Object construct(Node node) {
        if (!(node instanceof SequenceNode seqNode)) {
            throw new ConstructorException("while constructing a long array", node.getStartMark(),
