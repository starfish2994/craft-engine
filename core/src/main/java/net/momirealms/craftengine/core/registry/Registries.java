...
public final class Registries {
    ...
    public static final ResourceKey<Registry<NetworkEncryptionType<? extends Encryption>>> NETWORK_ENCRYPTION_TYPE = ResourceKey.create(ROOT_REGISTRY, Key.withCraftEngineNamespace("network_encryption_type"));
}
