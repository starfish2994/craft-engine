...
public enum AutoStateGroup {
    ...
    INACTIVE_PRESSURE_PLATE("inactive_pressure_plate", Set.of(BlockKeys.LIGHT_WEIGHTED_PRESSURE_PLATE, BlockKeys.HEAVY_WEIGHTED_PRESSURE_PLATE), (w) -> !(boolean) w.getProperty("powered")),
    POWERED_PRESSURE_PLATE("powered_pressure_plate", Set.of(BlockKeys.LIGHT_WEIGHTED_PRESSURE_PLATE, BlockKeys.HEAVY_WEIGHTED_PRESSURE_PLATE), (w) -> w.getProperty("powered")),
