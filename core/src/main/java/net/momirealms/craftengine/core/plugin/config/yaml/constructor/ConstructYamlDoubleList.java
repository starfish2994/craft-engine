...
public class ConstructYamlDoubleList extends ConstructYamlDouble implements ConstructNode {
    ...
    public Object construct(Node node) {
        ...
        DoubleArrayList result = new DoubleArrayList(valueList.size());
