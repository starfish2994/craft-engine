...
public class ConstructYamlIntArray extends ConstructYamlInt implements ConstructNode {

    @Override
    public Object construct(Node node) {
        if (!(node instanceof SequenceNode seqNode)) {
            throw new ConstructorException("while constructing an int array", node.getStartMark(),
